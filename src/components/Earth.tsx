    ...
    <div className="App">
      <header className="bg-black App-header">
        <div className="relative flex flex-col">
          <div className="bg-gradient-to-br from-gray-700 via-gray-900 to-black max-xs:bg-slate-700 max-xs:rounded-[2px] bg-blue-500 max-xs:left-[200px] max-xs:opacity-1 relative left-[0px] rounded-full h-[00px] max-xs:w-[20px] max-xs:h-[200px] w-[00px] App-logo"></div>
          <img
